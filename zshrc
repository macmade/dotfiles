...
if [ -d ~/Documents/Macmade/DigiDNA/GitHub/iMazing-Mac/release ];     then alias imr="cd ~/Documents/Macmade/DigiDNA/GitHub/iMazing-Mac/release     && tmux new-session \; send-keys \"clear && git status\" C-m \; split-window \; send-keys \"clear && tig\" C-m \; split-window -h \; send-keys \"cd DDNAToolKit && clear && tig\" C-m \; selectp -t 0 \; split-window -h -p 40 \; send-keys \"clear && vim\" C-m \; selectp -t 0 \; attach"; fi
...
if [ -d ~/Documents/Macmade/DigiDNA/GitHub/iMazing-Win/release ];     then alias iwr="cd ~/Documents/Macmade/DigiDNA/GitHub/iMazing-Win/release     && tmux new-session \; send-keys \"clear && git status\" C-m \; split-window \; send-keys \"clear && tig\" C-m \; split-window -h \; send-keys \"cd DDNAToolKit && clear && tig\" C-m \; selectp -t 0 \; split-window -h -p 40 \; send-keys \"clear && vim\" C-m \; selectp -t 0 \; attach"; fi
